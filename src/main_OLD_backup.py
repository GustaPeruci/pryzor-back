...
app = FastAPI(
    ...
    description="Production-ready Steam price prediction API powered by MySQL + ML v2.0",
    version="6.0.0 - MySQL + ML v2.0"
)
...
# Lazy singleton for ML predictor service
...
async def ml_predict_single(appid: int, predictor: MLDiscountPredictor = Depends(get_ml_predictor)):
    ...
    - reasoning: fatores que influenciaram a predição
    """
...
@app.post("/api/ml/v2/predict/batch")
...
if __name__ == "__main__":
    import uvicorn
    print("🚀 Iniciando Pryzor API MySQL Production + ML v2.0...")
